select  ma.materia,t.idturmas,t.turma,a.idaluno,a.nome,a.endereco,a.bairro,a.complemento,a.cidade
from aluno as a 
...
where ma.idmaterias = 1 or ma.idmaterias = 2 or ma.idmaterias = 5 or ma.idmaterias = 6